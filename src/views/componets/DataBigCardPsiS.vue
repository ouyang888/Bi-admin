    ...
    <div class="content">
      <div class="content-item" v-for="(child,k) in inner" :key="k+21">
        <div class="goal">
          ...
          <span class="blue">{{child.info.onLineRadio}}%</span>
        </div>
        ...
        <div class="remarks">
          ...
          <p>
            <span class="light-white">毛利率</span> <span
              class="light-blue">75%</span>
              <span class="light-white">线上</span> <span
              class="light-blue">75%</span>
              <span class="light-white">线下</span> <span
              class="light-blue">75%</span>
            </p>
        </div>
